...
<div class="container py-4">
    ...
    <ul class="nav nav-tabs mb-4">
        ...
        <li class="nav-item">
            <a class="nav-link active text-white bg-primary" aria-current="page" href="#">Productos / Actualizar producto</a>
        </li>
    </ul>

    <!-- Título principal -->
    <h2 class="fw-bold">Actualizar producto</h2>
    <p class="text-muted mb-4">Actualice la información de su producto.</p>
